                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Déconexion
                                <a class="dropdown-item" href="#"><i class="fas fa-power-off mr-2"></i>Paramètre</a>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="#">Dashboard E-Book</a>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="product-thumbnail">
                                        <div class="product-img-head">
                                            ...
                                            <div class="ribbons-text">Article</div>
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-btn">
                                                ...
                                                <a href="#" class="btn btn-outline-light">Détaille</a>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <li class="page-item"><a class="page-link" href="#">Precédent</a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">
                            <div class="product-sidebar">
                                ...
                                <div class="product-sidebar-widget">
                                    <h4 class="product-sidebar-widget-title">Categories</h4>
                                ...
                                <div class="product-sidebar-widget">
                                    <h4 class="product-sidebar-widget-title">Prix</h4>
                                    <div class="custom-control custom-checkbox">
                                ...
                                <div class="product-sidebar-widget">
                                    <a href="#" class="btn btn-outline-light">Renitialiser le filtre </a>
                                </div>
                            </div>
                        </div>
                    </div>
