            ...
            <div class="main-container">
                <div class="navbar bg-white breadcrumb-bar border-bottom">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Overview</a>
                            </li>
                            <li class="breadcrumb-item"><a href="pages-app">App Pages</a>
                            </li>
                    ...
                    <div class="chat-module">
                        <div class="chat-module-top">
                            ...
                            <div class="chat-module-body">
                                ...
                                <div class="media chat-item">
                                    <img alt="William" src="{{asset('../assets/images/avatar-1.jpg')}}" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author">William</span>
                                            ...
                                            <div id="test-list-2">
                                                <form class="px-3 mb-3">
                                                    <div class="input-group input-group-round">
                                                        ...
                                                        <input type="text" class="form-control search" placeholder="Fier members" aria-label="Filter Members">
                                                    </div>
                                                </form>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="David Whittaker" src="{{asset('../assets/images/avatar-4.jpg')}}" class="avatar filter-by-data-title" data-title="David Whittaker" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
